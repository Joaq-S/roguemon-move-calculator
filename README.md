...
Storm Throw, Surging Strikes, Wicked Blow, Zippy Zap).
...
| `data/moves.txt`, `data/pokemon_raw.txt` | Raw extracts from pokemondb.net (`/move/all`, `/pokedex/all`) |
...
The URL remembers your loadout (e.g. `#mon=Pikachu&moves=Thunderbolt|Iron Tail|...`), so
